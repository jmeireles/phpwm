...
void watch_events() {
	...
	while ((event = xcb_wait_for_event(xconnection))) {
		...
		case XCB_BUTTON_RELEASE:
			...
			break;
			//		case XCB_POINTER_MOTION:
			//			cout << "Event:XCB_POINTER_MOTION" << endl;
			//			event_pointer_motion(event);
			//			break;
			//		case XCB_ENTER_WINDOW:
			//			cout << "Event:XCB_ENTER_WINDOW" << endl;
			//			event_enter_window(event);
			//			break;
			//		case XCB_LEAVE_WINDOW:
			//			cout << "Event:XCB_LEAVE_WINDOW" << endl;
			//			event_leave_window(event);
			//			break;
		case XCB_KEY_PRESS:
